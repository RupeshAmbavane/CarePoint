            ...
            <section id="contact" className="contact mt-5 mb-5">
                        ...
                        <div className="col-lg-4">
                            <div className="info rounded p-3" style={{ background: '#f8f9fa' }}>
                                <div className="d-flex mb-2 gap-2">
                                    ...
                                    <div>
                                        <h4>Location:</h4>
                                        <p>Mumbai, India<br /><span className="form-text">Navi Mumbai</span></p>
                                    </div>
                                </div>
                                ...
                                <div className="d-flex mb-2 gap-2">
                                    ...
                                    <div>
                                        <h4>Email:</h4>
                                        <p>rupeshambavane90@gmail.com</p>
                                    </div>
                                </div>
                ...
                <div>
                    <div className="container">
                        ...
                        <iframe style={{ border: 0, width: "100%", height: "350px" }} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15079.392...!2d72.8777!3d19.0760!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b63d2c4a7b45%3A0xabcdef!2sMumbai%2C%20Maharashtra%2C%20India!5e0!3m2!1sen!2sin!4v1690000000000" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </section>
            <Footer />
